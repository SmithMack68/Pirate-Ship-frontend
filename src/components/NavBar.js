...
const NavBar = () => {
  return (
    <div style={{fontFamily: "fantasy", textAlign: "justify", color:"#4087A5"}}>
      <ul>
        <nav>
        <li><Link to="/home" style={{fontFamily: "fantasy", textAlign: "justify", color:"#6991B3", fontSize: 35}}>Home</Link></li>
        ...
        {/* <li><Link to="/ships/crew" style={{fontFamily: "fantasy", textAlign: "justify", color:"#6991B3", fontSize: 35}}></Link></li> */}
